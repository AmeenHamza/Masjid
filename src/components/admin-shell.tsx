...
const links = [
  ...
  { href: '/admin/madrasa-records', icon: Globe, key: 'madrasaRecords' },
  { href: '/admin/mosque-bedding', icon: Globe, key: 'mosqueBedding' },
  { href: '/admin/staff-records', icon: Globe, key: 'staffRecords' },
