...
export function SectionPage({ title, subtitle, summary, rows, columns }: SectionPageProps) {
  return (
    <main className="mx-auto max-w-7xl px-4 py-10 lg:px-6">
      <div className="mb-8">
        <p className="text-sm uppercase tracking-[0.3em] text-emerald-700">Jami Masjid Noori & Madrasa</p>
